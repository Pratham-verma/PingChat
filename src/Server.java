...
public class Server extends JFrame{
    ...
    {
         try {
             server =  new ServerSocket(7777); // port 7777 is used for, both TCP and UDP
        ...
        Runnable r2=()->{
            ...
            try {
                ...
                while(!socket.isClosed()) {
                    ...
                    out.println(content);
                    out.flush();      // This command is used to ensure that any buffered data in the output stream
                                     // (out) is immediately written or flushed to its destination
